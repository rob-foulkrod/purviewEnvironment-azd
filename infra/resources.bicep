...
@description('Please specify a suffix to append to the resource names')
param suffix string
...
resource swsadls 'Microsoft.Storage/storageAccounts@2023-05-01' = {
  name: 'pvdemo${take(suffix, 9)}synapsedl'
  location: location
  kind: 'StorageV2'
  sku: {
    name: 'Standard_LRS'
...
output identity string = userAssignedIdentity.properties.principalId
